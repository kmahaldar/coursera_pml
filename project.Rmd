...
##  R package
## Following packages are considered for the project , 
### there are multiple ways to create the prediction 
### few packages like caret , rpart are to be used in all possible solution
### few packages like rattle , repmis are to be used depnding on developer's choice



##  Install required R packages
## If any of the following packages are not yet installed , then install by running the line individually
...
### actually I have tried many algorithms and finally selected random Forest as it produces best accuracy among the tried methdods

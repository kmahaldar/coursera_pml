...
---
### I have added the output from RStudio console in this rmd file , that is just for your conveneince, these results are commented out using '####' inside the R code chunk 
